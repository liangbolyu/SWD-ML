...
- __simulation1.R__ contains the code for the constant treatment effect under both cluster and individual randomized trials.
- __simulation2.R__ contains the code for the duration treatment effect under both cluster and individual randomized trials.
